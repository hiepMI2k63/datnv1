            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="/tryitnow/Home/CreateOrder">Tạo mới
        ...
        <div class="table-responsive">
            <form action="/tryitnow/Home/CreateOrder" id="frmCreateOrder" method="post">
                ...
                <input name="__RequestVerificationToken" type="hidden"
                    value="02co6nJxiIPwhm-KB9sZGNVDW2-aA-oadquxiG9nEFcLMauWxHBIblvc22aRgSUgpj5KsqcKOizQgb37r3oGorC-IaXucJVK4_DBO4HEE0U1" />
            </form>
        </div>
        <p>
            &nbsp;
